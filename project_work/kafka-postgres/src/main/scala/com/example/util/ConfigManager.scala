...
object ConfigManager{
  object PostgreSqlConfig extends ConfigManager(Some("postgresql"))
  object KafkaConfig extends ConfigManager(Some("kafka"))
  object SparkConfig extends ConfigManager(Some("spark"))
}